		...
		<div class="col-md-12">
			...
			<table class="table table-bordered table-sm">
				...
				<tr>
					...
					<a href="<?=base_url()?>admin/delivered_order/<?=$row['order_tbl_id']?>">
						<button class="btn btn-primary p-0 pl-1 pr-1">Delivered</button>
					</a>
					<a href="<?=base_url()?>admin/view_order/<?=$row['order_tbl_id']?>">
						<button class="btn btn-info p-0 pl-1 pr-1">View</button>
					</a>
					<a href="<?=base_url()?>admin/return_order/<?=$row['order_tbl_id']?>" onclick="return confirm('Are You Sure..?')">
						<button class="btn btn-danger p-0 pl-1 pr-1">Return</button>
					</a>	
					</td>
					<td><?=$key + 1?></td>
					<td><?=$row['fullname']?></td>
